...
function startup()
{
	...
	nohup python3 crawler_booter.py --usage crawler common ajax > crawler1.log 2>&1 &
	nohup python3 crawler_booter.py --usage crawler common ajax > crawler2.log 2>&1 &
	...
	nohup python3 crawler_booter.py --usage validator init init_socks4 > init_validator4.log 2>&1 &
	...
	nohup python3 crawler_booter.py --usage validator https > https_validator1.log 2>&1 &
	nohup python3 crawler_booter.py --usage validator https > https_validator2.log 2>&1 &
