...
function startup()
{
	...
	nohup python3 crawler_booter.py --usage validator https http > https_validator.log 2>&1&
	nohup python3 scheduler_booter.py --usage validator https http > validator_scheduler.log 2>&1 &
}
