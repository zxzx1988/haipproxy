...
TEMP_XWEB_QUEUE = 'haipproxy:xweb:temp'
...
VALIDATED_XWEB_QUEUE = 'haipproxy:validated:xweb'
...
TTL_XWEB_QUEUE = 'haipproxy:ttl:xweb'
...
SPEED_XWEB_QUEUE = 'haipproxy:speed:xweb'
